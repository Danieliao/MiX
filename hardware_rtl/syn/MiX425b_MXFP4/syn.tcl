#==============================================================================
# Synthesis script -- MiX425b_MXFP4   (top-level module: MiX425b_MXFP4_SystolicArray)
#
# Reproduces the "MiX425b_MXFP4" row of ../../results_28nm_iso512.csv.
#
# HOW TO RUN
...
#   3. Read the results:
#        Area  -> log/MiX425b_MXFP4_SystolicArray.2.28nm.syn_area.28nm.rpt    ("Total cell area", um^2)
#        Power -> log/MiX425b_MXFP4_SystolicArray.2.28nm.syn_power.28nm.rpt   ("Total Power", mW)
#        Timing-> log/MiX425b_MXFP4_SystolicArray.2.28nm.syn_timing.28nm.rpt  (slack must be >= 0)
#
...
# Set top level name
set top_level "MiX425b_MXFP4_SystolicArray"

# RTL source -- relative to this directory, no editing needed
set VERILOG_DIR "../../src/systolic_arrays/MiX425b_MXFP4"

set RTL_SRC_FILES [list \
"$VERILOG_DIR/MiX425b_MXFP4_MUL.sv" \
"$VERILOG_DIR/MiX425b_MXFP4_PE.sv" \
"$VERILOG_DIR/MiX425b_MXFP4_SystolicArray.sv" \
]
