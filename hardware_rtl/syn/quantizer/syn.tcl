#==============================================================================
# Synthesis script -- quantizer   (top-level module: MiX_MX_Quantizer)
#
# Reproduces the "quantizer" row of ../../results_28nm_iso512.csv.
#
# HOW TO RUN
...
#   3. Read the results:
#        Area  -> log/MiX_MX_Quantizer.2.28nm.syn_area.28nm.rpt    ("Total cell area", um^2)
#        Power -> log/MiX_MX_Quantizer.2.28nm.syn_power.28nm.rpt   ("Total Power", mW)
#        Timing-> log/MiX_MX_Quantizer.2.28nm.syn_timing.28nm.rpt  (slack must be >= 0)
#
...
# Set top level name
set top_level "MiX_MX_Quantizer"

# RTL source -- relative to this directory, no editing needed
set VERILOG_DIR "../../src/quantizer"

set RTL_SRC_FILES [list \
"$VERILOG_DIR/MiX_MX_Quantizer.sv" \
"$VERILOG_DIR/Quantizer_PerElement.sv" \
"$VERILOG_DIR/Quantizer_Rounder.sv" \
"$VERILOG_DIR/Quantizer_ComparatorTree.sv" \
]
