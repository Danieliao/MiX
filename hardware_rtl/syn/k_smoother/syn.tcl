#==============================================================================
# Synthesis script -- k_smoother   (top-level module: K_SMOOTH_ARRAY)
#
# Reproduces the "k_smoother" row of ../../results_28nm_iso512.csv.
#
# HOW TO RUN
...
#   3. Read the results:
#        Area  -> log/K_SMOOTH_ARRAY.2.28nm.syn_area.28nm.rpt    ("Total cell area", um^2)
#        Power -> log/K_SMOOTH_ARRAY.2.28nm.syn_power.28nm.rpt   ("Total Power", mW)
#        Timing-> log/K_SMOOTH_ARRAY.2.28nm.syn_timing.28nm.rpt  (slack must be >= 0)
#
...
# Set top level name
set top_level "K_SMOOTH_ARRAY"

# RTL source -- relative to this directory, no editing needed
set VERILOG_DIR "../../src/k_smoother"

set RTL_SRC_FILES [list \
"$VERILOG_DIR/FP32_ADDSUB.sv" \
"$VERILOG_DIR/FP32_MUL.sv" \
"$VERILOG_DIR/K_SMOOTHER.sv" \
"$VERILOG_DIR/K_SMOOTH_ARRAY.sv" \
]
