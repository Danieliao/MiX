#==============================================================================
# Synthesis script -- INT8   (top-level module: INT8_SystolicArray)
#
# Reproduces the "INT8" row of ../../results_28nm_iso512.csv.
#
# HOW TO RUN
...
#   3. Read the results:
#        Area  -> log/INT8_SystolicArray.2.28nm.syn_area.28nm.rpt    ("Total cell area", um^2)
#        Power -> log/INT8_SystolicArray.2.28nm.syn_power.28nm.rpt   ("Total Power", mW)
#        Timing-> log/INT8_SystolicArray.2.28nm.syn_timing.28nm.rpt  (slack must be >= 0)
#
...
# Set top level name
set top_level "INT8_SystolicArray"

# RTL source -- relative to this directory, no editing needed
set VERILOG_DIR "../../src/systolic_arrays/INT8"

set RTL_SRC_FILES [list \
"$VERILOG_DIR/INT8_MUL.sv" \
"$VERILOG_DIR/INT8_PE.sv" \
"$VERILOG_DIR/INT8_SystolicArray.sv" \
]
