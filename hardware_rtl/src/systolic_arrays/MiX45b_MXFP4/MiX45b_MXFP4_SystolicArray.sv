module MiX45b_MXFP4_SystolicArray #(
    ...
    // MXFP4 weight inputs (left side): 2 groups per row
    , input logic [ROWS-1:0][group_size/wgt_group_size-1:0][shared_exp_bits-1:0] mxfp4_exp_in
    ...
    , output logic [ROWS-1:0][group_size/wgt_group_size-1:0][shared_exp_bits-1:0] mxfp4_exp_out
    ...
    logic [ROWS-1:0][COLS:0][NUM_WGT_GROUPS-1:0][shared_exp_bits-1:0] mxfp4_exp_wire;
