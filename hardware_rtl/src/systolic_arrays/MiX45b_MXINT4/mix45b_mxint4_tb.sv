// Self-checking testbench for MiX45b_MXINT4_PE
// (MiX-4.5b INVMX activation x MXINT4 weight, block_size = 32).
//
...
module mix45b_mxint4_tb;
    ...
    localparam int MANT_LIM          = 7;    // |w_mant| <= 7 for 4-bit
