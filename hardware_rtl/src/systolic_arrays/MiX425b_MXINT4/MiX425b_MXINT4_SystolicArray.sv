module MiX425b_MXINT4_SystolicArray #(
    ...
    // MXINT4 weight inputs (left side, one group per row)
    , input logic [ROWS-1:0][mxint_exp_bits-1:0] mxint_exp_in
    ...
    , output logic [ROWS-1:0][mxint_exp_bits-1:0] mxint_exp_out
    ...
    logic [ROWS-1:0][COLS:0][mxint_exp_bits-1:0] mxint_exp_wire;
