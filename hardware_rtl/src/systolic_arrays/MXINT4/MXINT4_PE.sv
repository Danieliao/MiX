module MXINT4_PE #(
    ...
    , input logic [mxint_exp_bits-1:0] mxint_a_exp_in
    , input logic signed [group_size-1:0][mxint_mant_bits-1:0] mxint_a_mant_in
    , input logic [mxint_exp_bits-1:0] mxint_b_exp_in
    ...
    , output logic [mxint_exp_bits-1:0] mxint_a_exp_out
    , output logic signed [group_size-1:0][mxint_mant_bits-1:0] mxint_a_mant_out
    , output logic [mxint_exp_bits-1:0] mxint_b_exp_out
    ...
    localparam DOT_OUT_BITS = (2 * mxint_mant_bits) + $clog2(group_size);
