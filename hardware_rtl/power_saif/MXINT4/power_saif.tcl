# AUTO-GENERATED -- SAIF-annotated power for MXINT4 (MXINT4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MXINT4_SystolicArray"
...
# Requires syn/MXINT4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MXINT4/output/${top}.ddc"
current_design $top
link
