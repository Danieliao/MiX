# AUTO-GENERATED -- SAIF-annotated power for MiX425b_MXINT4 (MiX425b_MXINT4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MiX425b_MXINT4_SystolicArray"
...
# Requires syn/MiX425b_MXINT4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MiX425b_MXINT4/output/${top}.ddc"
current_design $top
link
