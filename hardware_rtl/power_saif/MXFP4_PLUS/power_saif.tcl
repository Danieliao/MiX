# AUTO-GENERATED -- SAIF-annotated power for MXFP4_PLUS (MXFP4_PLUS_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MXFP4_PLUS_SystolicArray"
...
# Requires syn/MXFP4_PLUS to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MXFP4_PLUS/output/${top}.ddc"
current_design $top
link
