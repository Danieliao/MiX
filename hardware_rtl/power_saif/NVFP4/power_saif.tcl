# AUTO-GENERATED -- SAIF-annotated power for NVFP4 (NVFP4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "NVFP4_SystolicArray"
...
# Requires syn/NVFP4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/NVFP4/output/${top}.ddc"
current_design $top
link
