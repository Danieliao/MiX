# AUTO-GENERATED -- SAIF-annotated power for AMXFP4 (AMXFP4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "AMXFP4_SystolicArray"
...
# Requires syn/AMXFP4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/AMXFP4/output/${top}.ddc"
current_design $top
link
