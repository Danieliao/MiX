# AUTO-GENERATED -- SAIF-annotated power for MiX45b_MXINT4 (MiX45b_MXINT4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MiX45b_MXINT4_SystolicArray"
...
# Requires syn/MiX45b_MXINT4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MiX45b_MXINT4/output/${top}.ddc"
current_design $top
link
