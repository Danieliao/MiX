# AUTO-GENERATED -- SAIF-annotated power for INT4 (INT4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "INT4_SystolicArray"
...
# Requires syn/INT4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/INT4/output/${top}.ddc"
current_design $top
link
