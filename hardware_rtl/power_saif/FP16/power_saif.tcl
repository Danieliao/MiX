# AUTO-GENERATED -- SAIF-annotated power for FP16 (FP16_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "FP16_SystolicArray"
...
# Requires syn/FP16 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/FP16/output/${top}.ddc"
current_design $top
link
