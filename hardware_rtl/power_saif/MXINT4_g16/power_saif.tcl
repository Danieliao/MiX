# AUTO-GENERATED -- SAIF-annotated power for MXINT4_g16 (MXINT4_g16_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MXINT4_g16_SystolicArray"
...
# Requires syn/MXINT4_g16 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MXINT4_g16/output/${top}.ddc"
current_design $top
link
