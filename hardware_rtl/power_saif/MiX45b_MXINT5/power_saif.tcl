# AUTO-GENERATED -- SAIF-annotated power for MiX45b_MXINT5 (MiX45b_MXINT5_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MiX45b_MXINT5_SystolicArray"
...
# Requires syn/MiX45b_MXINT5 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MiX45b_MXINT5/output/${top}.ddc"
current_design $top
link
