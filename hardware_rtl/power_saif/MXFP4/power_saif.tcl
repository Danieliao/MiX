# AUTO-GENERATED -- SAIF-annotated power for MXFP4 (MXFP4_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "MXFP4_SystolicArray"
...
# Requires syn/MXFP4 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/MXFP4/output/${top}.ddc"
current_design $top
link
