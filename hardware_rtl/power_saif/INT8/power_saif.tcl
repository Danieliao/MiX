# AUTO-GENERATED -- SAIF-annotated power for INT8 (INT8_SystolicArray).
# Re-powers the already-synthesized .ddc; only switching activity differs.
set top "INT8_SystolicArray"
...
# Requires syn/INT8 to have been run first (it writes the .ddc reused here).
read_file -format ddc "../../syn/INT8/output/${top}.ddc"
current_design $top
link
